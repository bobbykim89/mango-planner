...
const DarkMode = () => {
  ...
  return (
    <Fragment>
      <div
        className='inline-block pt-1 pb-2 lg-pb-1 text-red-500 align-middle text-2xl ml-3 hover:text-white transition ease-in duration-150 cursor-pointer dark:text-yellow-400 dark:hover:text-white'
